  ...
  return (
    <div className="select-dropdown">
      ...
      >
        ...
        <option value="Charleston-South-Carolina">
          Charleston South Carolina
        </option>
        <option value="Boston-Massachuesets">Boston Massachuesetts</option>
        ...
        <option value="Weston-Supermare">Weston Supermare</option>
        <option value="Hull">Hull</option>
        <option value="Skegness-England">Skegness</option>

        <option value="Wales">Wales</option>
        <option value="Newport">Newport, Wales</option>
        <option value="Swansea">Swansea, Wales</option>
        ...
        <option value="Richmond-and-Delta">
          Richmond and Delta, B.C.
        </option>
        <option value="The-Tantramar-Marsh-in-New-Brunswick">
