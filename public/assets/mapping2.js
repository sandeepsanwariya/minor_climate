var zoom = {
  ...
  "Boston-Massachuesets": [11],
  "Virgin-Beach,-Virginia": [8],
  "Norfolk-VA": [12],
  "Redwood-City-CA": [12],
  "Hampton-VA": [12],
  ...
  "Quebec": [9],
  "Richmond-B.C.": [10],
  "The-Tantramar-Marsh-in-New-Brunswick": [9],
  "United-Kingdom": [6],
  London: [11],
  Bristol: [11],
  Cornwall: [9],
...
var data = {
  "United-States": [35, -90],
  Louisiana: [30.8596277, -95.8939549],
  "New-Orleans": [30.0318087, -90.4430207],
  Houston: [29.7444796, -95.2473936],
  "Corpus-Christi": [27.8, -97.5],
  "Atlantic-City-New-Jersey": [39.3765899, -74.522863],
  "New-York-City": [40.580167372403764, -73.9401855133474],
  "Charleston-South-Carolina": [32.8207333, -80],
  "Boston-Massachuesets": [42.3129855, -71],
  "Virgin-Beach-Virginia": [36.7579418, -76.2653492],
  "Norfolk-VA": [36.9579039, -76.4045241],
  "Redwood-City-CA": [37.5083527, -122.2856244],
  "Hampton-VA": [37.0229192, -76.4325434],
  "Urban-Honolulu-HI": [21.3278017, -158.079266],
  "Cambridge-MA": [42.378369, -71.1829495],
  "Mount-Pleasant-SC": [32.75, -79.85],
  "Quebec-Canada": [46.8560266, -71.6218733],
  "Richmond-and-Delta-B.C.": [49.1780976, -123.4161799],
  "The-Tantramar-Marsh-in-New-Brunswick-Canada": [45.8943, -64.3065],
  London: [51.5074, 0.1278],
  Exmouth: [50.65, -3.4],
  Exeter: [50.72, -3.45],
  Portsmouth: [50.799350807822286, -1.0408172523602846],
  Southampton: [50.913908, -1.4705325],
  Bristol: [51.4545, -2.5879],
  Cornwall: [50.4545, -4.5879],
  Devon: [50.75, -3.8],
  Plymouth: [50.36, -4.15],
  Weymouth: [50.6, -2.44],
  Poole: [50.72, -1.98],
  Bournemouth: [50.72, -1.88],
  Christchurch: [50.72, -1.75],
  Lymington: [50.76, -1.54],
  Eastbourne: [50.79, 0.31],
  Rye: [50.95, 0.77],
  Lydd: [50.95, 1],
  "New-Romney": [50.98, 1],
  Dover: [51.12, 1.3],
  Sandwich: [51.3, 1.35],
  Kent: [51.15, 0.9],
  "Weston-Supermare-England": [51.3430315, -3],
  Wales: [52.55, -2.95],
  Newport: [51.55, -2.95],
  Swansea: [51.62, -3.95],
  Cardiff: [51.47, -3.16],
  "Hull-England": [53.7662891, -45.4720678],
  "Skegness-England": [53.1487954, 0.2926906],
  "The-Bahamas": [24.1667876, -77],
  Florida: [27.6648, -81.5158],
  Miami: [25.761681, -80.191788],
  "Tampa-Bay": [27.9, -82.5],
  "New-York": [40.73061, -73.935242],
  Delaware: [38.5, -75],
  Amsterdam: [52.377956, 4.89707],
  Netherlands: [51.926517, 4.462456],
  "The-Hague": [52.078663, 4.288788],
  Venice: [45.438759, 12.3],
  "New-Orleans": [29.951065, -90.071533],
  Louisiana: [30.39183, -92.329102],
  "San-Francisco": [37.773972, -122.431297],
  "Virginia-Beach": [36.86314, -76.015778],
  Montreal: [45.508888, -73.561668],
  Hawaii: [19.6, -155.2236328145955],
  Tokyo: [35.652832, 139.839478],
  Kolkota: [22.572645, 88.363892],
  Mumbai: [19.07609, 72.877426],
  Dhaka: [23.777176, 90.399452],
  Shanghai: [31.224361, 121.46917],
  "Hong-Kong": [22.302711, 114.177216],
  Alexandria: [31.2238071, 29.6746967],
  "Rio-de-Janeiro": [-22.9138851, -43.7261746],
  Osaka: [34.6772776, 135.2058498],
  "American-Samoa": [-14.305711987770538, -170.7007316174498],
  "United-States-Minor-Outlying-Islands": [
    15.421124215614473, -61.98493557207482,
  ],
  ...
  "South-Georgia-and-South-Sandwich-Islands": [
    -55.79467861523634, -33.084862315910726,
  ],
...
var mapboxAccessToken =
  "pk.eyJ1Ijoic2FuZGVlcHNhbndhcml5YSIsImEiOiJja3A4ZmhvdGIwMTIyMm5zM2RxNWIya3h5In0.yuJS_cus0cl5UdGeQ-E5kg";
...
var base = L.tileLayer(
  ...
  {
    attribution:
      'Map data &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, &copy;<a href="https://www.mapbox.com/map-feedback/">Mapbox</a>',
    id: "mapbox.streets",
    tileSize: 512,
    zoomOffset: -1,
  }
...
var antitoner = L.tileLayer.gl({
  ...
  tileUrls: [
    "https://{s}.tiles.mapbox.com/v4/mapbox.terrain-rgb/{z}/{x}/{y}.pngraw?access_token=" +
      "pk.eyJ1Ijoic2FuZGVlcHNhbndhcml5YSIsImEiOiJja3A4ZmhvdGIwMTIyMm5zM2RxNWIya3h5In0.yuJS_cus0cl5UdGeQ-E5kg",
  ],
});
antitoner.addTo(map);
...
map.on("mousemove", function (ev) {
  console.log("lat-", ev.latlng.lat, "log", ev.latlng.lng);
});
...
function change_loc() {
  ...
  if (con.innerHTML in zoom) {
    var zm = zoom[con.innerHTML];
  } else {
    var zm = 8;
  }
  map.flyTo(data[con.innerHTML], zm);
  let cn = con.innerHTML;
  cn = cn.replace(/-/g, " ");
  newPageTitle = cn + " Sea Level Rise Map Animation";
  document.title = newPageTitle;
}
var loc_change = document.getElementById("country");
loc_change.oninput = function () {
  con = document.getElementById("c_name");
  c = document.getElementById("con_name_head");
  if (this.value in zoom) {
    var zm = zoom[this.value];
  } else {
    var zm = 8;
  }
  map.flyTo(data[this.value], zm);
  ...
  newPageTitle = country + " Sea Level Rise Map Animation";
  document.title = newPageTitle;
  c.innerHTML = country;
};
change_loc();
